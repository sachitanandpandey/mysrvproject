...
import com.b1strudio.srvdabba.Common.DirectionJSONParser;
import com.b1strudio.srvdabba.R;
import com.b1strudio.srvdabba.Remote.IGeoCoordinates;
        ...
        mService.getGeoCode(address).enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    ...
                    Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.drawable.paperbag);
